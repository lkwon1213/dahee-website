...
//https://codepen.io/easymac/pen/REobaa
//Another cool one https://codepen.io/Mertl/pen/ZqoMWK
...
class Smoke extends Component {
  ...
  render() {
    ...
    function Path() {
      ...
      this.getLength = () =>
        this.curves.reduce((acc, cur) => acc + cur.length, 0);
      ...
      this.toBezier = () => {
        return (
          this.forcedBezier || {
            ...
            cp1: [
              this.startPoint[0],
              this.startPoint[1] + this.startWhiskerLength
            ],
...
*/
    return (
      <div className="smoke">
        ...
        <div className="overlay">SMOKE</div>
      </div>
    );
  }
}
